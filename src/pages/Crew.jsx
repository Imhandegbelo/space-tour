...
export default function Crew() {
  ...
  return (
    <div className="h-screen w-screen lg:pt-10 bg-crew-mobile md:bg-crew-tablet lg:bg-crew-desktop bg-cover overflow-y-clip">
      <Navbar />
      <div className="flex flex-col gap-16 lg:gap-0 lg:flex-rcow lg:px-36 lg:mt-36 items-center justify-between text-gray-300">
        {/* <div className="border w-full text-left lg:text-center"> */}
        ...
        {/* </div> */}
        <div className="flex flex-col gap-16 lg:gap-0 lg:flex-row justify-between w-full">
          <div className="flex flex-col gap-10 lg:gap-20 h-4/5 px-6 justify-">
            <div className="grid gap-1 lg:gap-6 lg:mt-10 text-center lg:text-left">
              <h2 className="font-Bellefair tracking-[2.7px] text-base md:text-[2rem] uppercase mb-2">
          ...
          <div className="flex order-start px-8 md:px-0 lg:-mt-40">
            <img src={images[active]} alt={"name"} className="shrink mx-auto" />
          </div>
        </div>
      </div>
    </div>
